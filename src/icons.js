/**
 * Lucide 圖示（stroke-width 1.8、viewBox 24）— 供 JS 動態樣板用。
 * CIS §4：新專案一律 lucide、禁 emoji。靜態 chrome 圖示直接內嵌在 index.html。
 */
const PATHS = {
  mic: '<path d="M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3Z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" x2="12" y1="19" y2="22"/>',
  // 喇叭：沿用 history.js 既有 lucide volume-2 路徑，全站播放鍵統一
  volume:
...
/** 回傳一段內嵌 lucide SVG 字串（currentColor 繼承文字色） */
